...
const NewAccountPreview = memo(({ newAccount, closeMW, newAccountNameInput, newAccountCountInput }) => {
    ...
    const [request, isLoading, error] = useRequest(async () => {
        ...
        closeMW()
	    if (newAccountNameInput.current) newAccountNameInput.current.clear()
	    if (newAccountCountInput.current) newAccountCountInput.current.clear()
    })
